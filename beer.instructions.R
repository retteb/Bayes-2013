...
## Gist: https://gist.github.com/jkarreth/5737042
...
## For more info: jags.tutorial.pdf on http://spot.colorado.edu/~joka5204/Bayes2013.html
...
beer.inits <- function(){
  list("b1"=c(0.56), "b2"=c(-0.05), "b3"=c(0.95), "b4"=c(0.03), "theta"=c(7,10))
}
